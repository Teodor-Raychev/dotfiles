...
module.exports = {
    config: {
        ...
        // 12 makes _ with wierd background.
        fontSize: 13,
        ...
        //	cursorColor: 'rgba(235, 52, 79, 0.8)',
    ...
    //   `@company/project`
    //   `project#1.0.1`
    plugins: ['hypercwd', 'hyper-pane', 'hyper-tabs-enhanced'],
    ...
    //windows: see: https://github.com/vercel/hyper/blob/master/app/keymaps/win32.json
    //linux:
